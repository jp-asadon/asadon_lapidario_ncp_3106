...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $time_management = $_POST['time_management'];
       ...
       // Check if program_flow is set and retrieve the selected value
    if (isset($_POST['time_management'])) {
        $time_management = $_POST['time_management'];
    } else {
        $time_management = null; // Set a default value if no option is selected
    }

   // Check if program_flow is set and retrieve the selected value
    if (isset($_POST['venue_and_fac'])) {
        $venue = $_POST['venue_and_fac'];
    } else {
        $venue = null; // Set a default value if no option is selected
    }


       // Check if program_flow is set and retrieve the selected value
       if (isset($_POST['speakers_performers'])) {
        $speaker = $_POST['speakers_performers'];
    } else {
        $speaker = null; // Set a default value if no option is selected
    }
           ...
           if (isset($_POST['topics'])) {
            ...
            $topic = null; // Set a default value if no option is selected
        }
    

               // Check if program_flow is set and retrieve the selected value
               if (isset($_POST['facilitators'])) {
                $facilitator = $_POST['facilitators'];
            } else {
                $facilitator = null; // Set a default value if no option is selected
            }
                      ...
                      if (isset($_POST['overall_rating'])) {
                        ...
                        $overall_rating = null; // Set a default value if no option is selected
                    }
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="survey-container">
                                            <div class="emoji-container">
                                                ...
                                                <label for="time_management-star5">🤩<span class="label-text">Excellent</span> </label>
                                            </div>
                                            <div class="emoji-container">
                                            ...
                                            <div class="emoji-container">
                                                ...
                                                <label for="time_management-star1">😡<span class="label-text">Extremely Poor</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="survey-container">
                                            ...
                                            <input type="radio" name="venue_and_fac" id="venue_and_fac-star2" value="2">
                                                <label for="venue_and_fac-star2">😞<span class="label-text">Poor</span></label>
                                            </div>
                                            <div class="emoji-container">
                                            <input type="radio" name="venue_and_fac" id="venue_and_fac-star1" value="1">
                                                <label for="venue_and_fac-star1">😡<span class="label-text">Extremely Poor</span>
                                                </label>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card" style="margin: 5px;">
                                    <div class="card-body">
                                        ...
                                        <div class="survey-container">
                                            <div class="emoji-container">
                                            <input type="radio" name="speakers_performers" id="speakers_performers-star5" value="5">
                                            ...
                                            <div class="emoji-container">
                                            <input type="radio" name="speakers_performers" id="speakers_performers-star3" value="3">
                                                <label for="speakers_performers-star3">😐<span class="label-text">Satisfactory</span></label>
                                            </div>
                                            <div class="emoji-container">
                                            <input type="radio" name="speakers_performers" id="speakers_performers-star2" value="2">
                                                <label for="speakers_performers-star2">😞<span class="label-text">Poor</span></label>
                                            </div>
                                            <div class="emoji-container">
                                            <input type="radio" name="speakers_performers" id="speakers_performers-star1" value="1">
                                                <label for="speakers_performers-star1">😡<span class="label-text">Extremely Poor</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="survey-container">
                                            ...
                                            <input type="radio" name="topics" id="topics-star5" value="5">
                                                <label for="topics-star5">🤩<span class="label-text">Excellent</span></label>
                                            </div>
                                            <div class="emoji-container">
                                            ...
                                            <input type="radio" name="topics" id="topics-star1" value="1">
                                                <label for="topics-star1">😡<span class="label-text">Extremely Poor</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="survey-container">
                                            ...
                                            <input type="radio" name="facilitators" id="facilitators-star4" value="4">
                                                <label for="facilitators-star4">😊<span class="label-text">Very Satisfactory</span></label>
                                            </div>
                                            <div class="emoji-container">
                                            ...
                                            <label for="facilitators-star1">😡<span class="label-text">Extremely Poor</span></label>
                                            </div>
                                        </div>
                                    </div>
                                </div>
